<template>
  <div class="flex h-full w-full relative">
    ...
    <div class="h-full w-full" v-if="selectedRecipient !== undefined">
      <div class="block h-full w-full">
        <MainChat :selected-recipient="selectedRecipient" @remove-selected="RemoveSelected()"/>
      </div>
